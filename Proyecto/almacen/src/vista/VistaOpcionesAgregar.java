...
import controlador.ControlOpcionesAgregar;
 ...
 * @author charlis
 */
public class VistaOpcionesAgregar extends javax.swing.JFrame {

    private final ControlOpcionesAgregar controlador;
    public VistaOpcionesAgregar() {
        controlador = new ControlOpcionesAgregar(this);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaOpcionesAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaOpcionesAgregar().setVisible(true);
            }
        });
    }
