...
import controlador.ControlOpcionesActualizar;
 ...
 * @author charlis
 */
public class VistaOpcionesActualizar extends javax.swing.JFrame {

    private final ControlOpcionesActualizar controlador;
    public VistaOpcionesActualizar() {
        controlador = new ControlOpcionesActualizar(this);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaOpcionesActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaOpcionesActualizar().setVisible(true);
            }
        });
    }
